...
def list_events(
    ...
    for e in events:
        ...
        items.append(EventListItem(
            ...
            registered_count=max(reg_counts.get(e.id, 0), (e.display_registrant_count or 0)),
            publisher_nickname=publisher.nickname if publisher else "",
            publisher_avatar=publisher.avatar_url if publisher else "",
            registrant_count=max(reg_counts.get(e.id, 0), (e.display_registrant_count or 0)),
...
def get_event(
    ...
    # 如果设置了display_registrant_count，优先显示
    display_val = event.display_registrant_count
    ...
    return EventInfo(
        ...
        registrant_count=max(registrant_count, display_val or 0),
