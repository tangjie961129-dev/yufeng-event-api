...
class AgentProfileItem(BaseModel):
    ...
    parent_agent_user_id: Optional[int] = None
    parent_agent_name: str = ""
    service_region: str = ""
    direct_commission_rate: float = 50.0
    management_base_rate: float = 10.0
    management_bonus_rate: float = 0.0
...
class ReferralBindingItem(BaseModel):
    ...
    source_code: str
    source_scene: str = ""
    source_platform: str = "mini_program"
    campaign_code: str
    landing_page: str
    status: str
...
class AgentTeamManagementBonusLedgerItem(BaseModel):
    id: int
    regional_partner_user_id: int
    regional_partner_name: str
    ...
    source_order_id: str
    source_commission_ledger_id: Optional[int] = None
    base_amount: float
    base_rate: float
...
class AgentTeamManagementBonusLedgerListResponse(BaseModel):
    items: List[AgentTeamManagementBonusLedgerItem]
    total: int
    page: int
    page_size: int
...
class ReferralBindingCreateRequest(BaseModel):
    ...
    source_scene: str = Field(default="", max_length=255)
    source_platform: str = Field(default="mini_program", max_length=30)
